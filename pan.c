...
{	int j, h = now._nr_pr;
	...
	case 2:	/* startup */
		...
		/* params: */
		/* locals: */
		((P2 *)pptr(h))->_10_portctr = 0;
		((P2 *)pptr(h))->_10_ctr = 0;
#ifdef VAR_RANGES
		logval("startup:portctr", ((P2 *)pptr(h))->_10_portctr);
		logval("startup:ctr", ((P2 *)pptr(h))->_10_ctr);
#endif
#ifdef HAS_CODE
		locinit2(h);
#endif
	...
	case 1:	/* controller */
		...
		/* params: */
		/* locals: */
		((P1 *)pptr(h))->_9_pactr = 0;
		((P1 *)pptr(h))->_9_lactr = 0;
		((P1 *)pptr(h))->_9_updtpktctr = 0;
		((P1 *)pptr(h))->_9_tctr0 = 0;
		((P1 *)pptr(h))->_9_tctr1 = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			((P1 *)pptr(h))->_9_timerctr[l_in] = 0;
		}
	}
#ifdef VAR_RANGES
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("controller:_9_timerctr[l_in]", ((P1 *)pptr(h))->_9_timerctr[l_in]);
		}
	}
		logval("controller:pactr", ((P1 *)pptr(h))->_9_pactr);
		logval("controller:lactr", ((P1 *)pptr(h))->_9_lactr);
		logval("controller:updtpktctr", ((P1 *)pptr(h))->_9_updtpktctr);
		logval("controller:tctr0", ((P1 *)pptr(h))->_9_tctr0);
		logval("controller:tctr1", ((P1 *)pptr(h))->_9_tctr1);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* router_node */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_8_pectr = 0;
		((P0 *)pptr(h))->_8_pactr = 0;
		((P0 *)pptr(h))->_8_swctr = 0;
		((P0 *)pptr(h))->_8_arbctr = 0;
		((P0 *)pptr(h))->_8_topologyctr = 0;
		((P0 *)pptr(h))->_8_updtctr = 0;
		((P0 *)pptr(h))->_8_updtpktctr = 0;
#ifdef VAR_RANGES
		logval("router_node:pectr", ((P0 *)pptr(h))->_8_pectr);
		logval("router_node:swctr", ((P0 *)pptr(h))->_8_swctr);
		logval("router_node:arbctr", ((P0 *)pptr(h))->_8_arbctr);
		logval("router_node:topologyctr", ((P0 *)pptr(h))->_8_topologyctr);
		logval("router_node:updtctr", ((P0 *)pptr(h))->_8_updtctr);
		logval("router_node:pactr", ((P0 *)pptr(h))->_8_pactr);
		logval("router_node:updtpktctr", ((P0 *)pptr(h))->_8_updtpktctr);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		...
		{
			now.arb_buff_g[0].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[0].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[1].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[1].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[2].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[2].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[3].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[3].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[4].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.arb_buff_g[4].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].inp_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].output_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].readbuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].writebuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[0].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[0].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[1].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[1].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[2].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[2].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[3].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[3].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[4].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arb_buff_g[4].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[0].arbitertoken_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].inp_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].output_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].readbuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].writebuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[0].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[0].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[1].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[1].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[2].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[2].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[3].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[3].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[4].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arb_buff_g[4].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[1].arbitertoken_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].inp_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].output_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].readbuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].writebuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[0].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[0].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[1].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[1].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[2].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[2].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[3].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[3].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[4].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arb_buff_g[4].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[2].arbitertoken_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].inp_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].output_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].readbuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].writebuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[0].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[0].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[1].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[1].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[2].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[2].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[3].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[3].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[4].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arb_buff_g[4].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[3].arbitertoken_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].inp_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].output_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].readbuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].writebuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[0].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[0].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[1].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[1].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[2].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[2].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[3].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[3].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[4].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arb_buff_g[4].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[4].arbitertoken_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].inp_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].output_status_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].readbuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].writebuff_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[0].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[0].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[1].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[1].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[2].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[2].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[3].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[3].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[4].req_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arb_buff_g[4].ack_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			now.router_id[5].arbitertoken_g[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[0].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[0].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[1].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[1].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[2].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[2].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[3].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[3].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[4].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			arb_buff[4].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].inp_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].output_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].readbuff_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].writebuff_h[l_in] = 0;
		}
	}
		router[0].start_packet_index = 0;
		router[0].end_packet_index = 0;
		router[0].packet_base_index = 0;
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[0].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[0].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[1].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[1].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[2].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[2].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[3].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[3].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[4].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arb_buff[4].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].arbitertoken[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].input_output_connection_map_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[0].input_output_connection_port_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].inp_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].output_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].readbuff_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].writebuff_h[l_in] = 0;
		}
	}
		router[1].start_packet_index = 0;
		router[1].end_packet_index = 0;
		router[1].packet_base_index = 0;
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[0].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[0].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[1].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[1].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[2].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[2].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[3].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[3].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[4].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arb_buff[4].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].arbitertoken[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].input_output_connection_map_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[1].input_output_connection_port_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].inp_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].output_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].readbuff_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].writebuff_h[l_in] = 0;
		}
	}
		router[2].start_packet_index = 0;
		router[2].end_packet_index = 0;
		router[2].packet_base_index = 0;
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[0].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[0].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[1].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[1].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[2].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[2].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[3].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[3].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[4].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arb_buff[4].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].arbitertoken[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].input_output_connection_map_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[2].input_output_connection_port_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].inp_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].output_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].readbuff_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].writebuff_h[l_in] = 0;
		}
	}
		router[3].start_packet_index = 0;
		router[3].end_packet_index = 0;
		router[3].packet_base_index = 0;
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[0].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[0].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[1].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[1].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[2].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[2].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[3].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[3].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[4].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arb_buff[4].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].arbitertoken[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].input_output_connection_map_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[3].input_output_connection_port_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].inp_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].output_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].readbuff_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].writebuff_h[l_in] = 0;
		}
	}
		router[4].start_packet_index = 0;
		router[4].end_packet_index = 0;
		router[4].packet_base_index = 0;
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[0].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[0].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[1].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[1].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[2].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[2].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[3].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[3].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[4].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arb_buff[4].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].arbitertoken[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].input_output_connection_map_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[4].input_output_connection_port_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].inp_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].output_status_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].readbuff_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].writebuff_h[l_in] = 0;
		}
	}
		router[5].start_packet_index = 0;
		router[5].end_packet_index = 0;
		router[5].packet_base_index = 0;
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[0].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[0].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[1].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[1].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[2].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[2].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[3].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[3].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[4].req[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arb_buff[4].ack[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].arbitertoken[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].input_output_connection_map_h[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			router[5].input_output_connection_port_h[l_in] = 0;
		}
	}
		packet_list[0].dest_index_x = 0;
		packet_list[0].dest_index_y = 0;
		packet_list[0].pkt_index = 0;
		packet_list[0].src_index_x = 0;
		packet_list[0].src_index_y = 0;
		packet_list[0].hopcount = 0;
		packet_list[0].timerref = 0;
		packet_list[1].dest_index_x = 0;
		packet_list[1].dest_index_y = 0;
		packet_list[1].pkt_index = 0;
		packet_list[1].src_index_x = 0;
		packet_list[1].src_index_y = 0;
		packet_list[1].hopcount = 0;
		packet_list[1].timerref = 0;
		packet_list[2].dest_index_x = 0;
		...
		packet_list[2].timerref = 0;
		packet_list[3].dest_index_x = 0;
		packet_list[3].dest_index_y = 0;
		packet_list[3].pkt_index = 0;
		packet_list[3].src_index_x = 0;
		packet_list[3].src_index_y = 0;
		packet_list[3].hopcount = 0;
		packet_list[3].timerref = 0;
		packet_list[4].dest_index_x = 0;
		packet_list[4].dest_index_y = 0;
		packet_list[4].pkt_index = 0;
		packet_list[4].src_index_x = 0;
		packet_list[4].src_index_y = 0;
		packet_list[4].hopcount = 0;
		packet_list[4].timerref = 0;
		packet_list[5].dest_index_x = 0;
		packet_list[5].dest_index_y = 0;
		packet_list[5].pkt_index = 0;
		packet_list[5].src_index_x = 0;
		packet_list[5].src_index_y = 0;
		packet_list[5].hopcount = 0;
		packet_list[5].timerref = 0;
		packet_list[6].dest_index_x = 0;
		packet_list[6].dest_index_y = 0;
		packet_list[6].pkt_index = 0;
		packet_list[6].src_index_x = 0;
		packet_list[6].src_index_y = 0;
		packet_list[6].hopcount = 0;
		packet_list[6].timerref = 0;
		packet_list[7].dest_index_x = 0;
		packet_list[7].dest_index_y = 0;
		packet_list[7].pkt_index = 0;
		packet_list[7].src_index_x = 0;
		packet_list[7].src_index_y = 0;
		packet_list[7].hopcount = 0;
		packet_list[7].timerref = 0;
		packet_status[0].txctr = 0;
		packet_status[0].rcvctr = 0;
		packet_status[0].packet_send = 0;
		packet_status[0].packet_receive = 0;
		packet_status[0].start_latencycount = 0;
		packet_status[0].stop_latencycount = 0;
		packet_status[0].latencycount = 0;
		packet_status[0].maxlatency = 0;
		packet_status[1].txctr = 0;
		packet_status[1].rcvctr = 0;
		packet_status[1].packet_send = 0;
		packet_status[1].packet_receive = 0;
		packet_status[1].start_latencycount = 0;
		packet_status[1].stop_latencycount = 0;
		packet_status[1].latencycount = 0;
		packet_status[1].maxlatency = 0;
		packet_status[2].txctr = 0;
		packet_status[2].rcvctr = 0;
		packet_status[2].packet_send = 0;
		packet_status[2].packet_receive = 0;
		packet_status[2].start_latencycount = 0;
		packet_status[2].stop_latencycount = 0;
		packet_status[2].latencycount = 0;
		packet_status[2].maxlatency = 0;
		packet_status[3].txctr = 0;
		packet_status[3].rcvctr = 0;
		packet_status[3].packet_send = 0;
		packet_status[3].packet_receive = 0;
		packet_status[3].start_latencycount = 0;
		packet_status[3].stop_latencycount = 0;
		packet_status[3].latencycount = 0;
		packet_status[3].maxlatency = 0;
		packet_status[4].txctr = 0;
		packet_status[4].rcvctr = 0;
		packet_status[4].packet_send = 0;
		packet_status[4].packet_receive = 0;
		packet_status[4].start_latencycount = 0;
		packet_status[4].stop_latencycount = 0;
		packet_status[4].latencycount = 0;
		packet_status[4].maxlatency = 0;
		packet_status[5].txctr = 0;
		packet_status[5].rcvctr = 0;
		packet_status[5].packet_send = 0;
		packet_status[5].packet_receive = 0;
		packet_status[5].start_latencycount = 0;
		packet_status[5].stop_latencycount = 0;
		packet_status[5].latencycount = 0;
		packet_status[5].maxlatency = 0;
		packet_status[6].txctr = 0;
		packet_status[6].rcvctr = 0;
		packet_status[6].packet_send = 0;
		packet_status[6].packet_receive = 0;
		packet_status[6].start_latencycount = 0;
		packet_status[6].stop_latencycount = 0;
		packet_status[6].latencycount = 0;
		packet_status[6].maxlatency = 0;
		packet_status[7].txctr = 0;
		packet_status[7].rcvctr = 0;
		packet_status[7].packet_send = 0;
		packet_status[7].packet_receive = 0;
		packet_status[7].start_latencycount = 0;
		packet_status[7].stop_latencycount = 0;
		packet_status[7].latencycount = 0;
		packet_status[7].maxlatency = 0;
		now.packet_status_g[0].txctr_g = 0;
		now.packet_status_g[0].rcvctr_g = 0;
		now.packet_status_g[0].packet_send_g = 0;
		now.packet_status_g[0].packet_receive_g = 0;
		now.packet_status_g[0].start_latencycount_g = 0;
		now.packet_status_g[0].stop_latencycount_g = 0;
		now.packet_status_g[0].latencycount_g = 0;
		now.packet_status_g[0].maxlatency_g = 0;
		now.packet_status_g[1].txctr_g = 0;
		now.packet_status_g[1].rcvctr_g = 0;
		now.packet_status_g[1].packet_send_g = 0;
		now.packet_status_g[1].packet_receive_g = 0;
		now.packet_status_g[1].start_latencycount_g = 0;
		now.packet_status_g[1].stop_latencycount_g = 0;
		now.packet_status_g[1].latencycount_g = 0;
		now.packet_status_g[1].maxlatency_g = 0;
		now.packet_status_g[2].txctr_g = 0;
		now.packet_status_g[2].rcvctr_g = 0;
		now.packet_status_g[2].packet_send_g = 0;
		now.packet_status_g[2].packet_receive_g = 0;
		now.packet_status_g[2].start_latencycount_g = 0;
		now.packet_status_g[2].stop_latencycount_g = 0;
		now.packet_status_g[2].latencycount_g = 0;
		now.packet_status_g[2].maxlatency_g = 0;
		now.packet_status_g[3].txctr_g = 0;
		now.packet_status_g[3].rcvctr_g = 0;
		now.packet_status_g[3].packet_send_g = 0;
		now.packet_status_g[3].packet_receive_g = 0;
		now.packet_status_g[3].start_latencycount_g = 0;
		now.packet_status_g[3].stop_latencycount_g = 0;
		now.packet_status_g[3].latencycount_g = 0;
		now.packet_status_g[3].maxlatency_g = 0;
		now.packet_status_g[4].txctr_g = 0;
		now.packet_status_g[4].rcvctr_g = 0;
		now.packet_status_g[4].packet_send_g = 0;
		now.packet_status_g[4].packet_receive_g = 0;
		now.packet_status_g[4].start_latencycount_g = 0;
		now.packet_status_g[4].stop_latencycount_g = 0;
		now.packet_status_g[4].latencycount_g = 0;
		now.packet_status_g[4].maxlatency_g = 0;
		now.packet_status_g[5].txctr_g = 0;
		now.packet_status_g[5].rcvctr_g = 0;
		now.packet_status_g[5].packet_send_g = 0;
		now.packet_status_g[5].packet_receive_g = 0;
		now.packet_status_g[5].start_latencycount_g = 0;
		now.packet_status_g[5].stop_latencycount_g = 0;
		now.packet_status_g[5].latencycount_g = 0;
		now.packet_status_g[5].maxlatency_g = 0;
		now.packet_status_g[6].txctr_g = 0;
		now.packet_status_g[6].rcvctr_g = 0;
		now.packet_status_g[6].packet_send_g = 0;
		now.packet_status_g[6].packet_receive_g = 0;
		now.packet_status_g[6].start_latencycount_g = 0;
		now.packet_status_g[6].stop_latencycount_g = 0;
		now.packet_status_g[6].latencycount_g = 0;
		now.packet_status_g[6].maxlatency_g = 0;
		now.packet_status_g[7].txctr_g = 0;
		now.packet_status_g[7].rcvctr_g = 0;
		now.packet_status_g[7].packet_send_g = 0;
		now.packet_status_g[7].packet_receive_g = 0;
		now.packet_status_g[7].start_latencycount_g = 0;
		now.packet_status_g[7].stop_latencycount_g = 0;
		now.packet_status_g[7].latencycount_g = 0;
		now.packet_status_g[7].maxlatency_g = 0;
#ifdef VAR_RANGES
		logval("startproc", now.startproc);
	{	int l_in;
		for (l_in = 0; l_in < 8; l_in++)
		{
			logval("injectpacket[l_in]", now.injectpacket[l_in]);
		}
	}
		logval("loop1ctr", now.loop1ctr);
		logval("loop2ctr", now.loop2ctr);
		logval("loop3ctr", now.loop3ctr);
		logval("loop4ctr", now.loop4ctr);
		logval("loop5ctr", now.loop5ctr);
		logval("loop6ctr", now.loop6ctr);
		logval("loop7ctr", now.loop7ctr);
		logval("testvar", now.testvar);
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[0].req_g[l_in]", now.arb_buff_g[0].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[0].ack_g[l_in]", now.arb_buff_g[0].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[1].req_g[l_in]", now.arb_buff_g[1].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[1].ack_g[l_in]", now.arb_buff_g[1].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[2].req_g[l_in]", now.arb_buff_g[2].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[2].ack_g[l_in]", now.arb_buff_g[2].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[3].req_g[l_in]", now.arb_buff_g[3].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[3].ack_g[l_in]", now.arb_buff_g[3].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[4].req_g[l_in]", now.arb_buff_g[4].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("arb_buff_g[4].ack_g[l_in]", now.arb_buff_g[4].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].inp_status_g[l_in]", now.router_id[0].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].output_status_g[l_in]", now.router_id[0].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].readbuff_g[l_in]", now.router_id[0].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].writebuff_g[l_in]", now.router_id[0].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[0].req_g[l_in]", now.router_id[0].arb_buff_g[0].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[0].ack_g[l_in]", now.router_id[0].arb_buff_g[0].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[1].req_g[l_in]", now.router_id[0].arb_buff_g[1].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[1].ack_g[l_in]", now.router_id[0].arb_buff_g[1].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[2].req_g[l_in]", now.router_id[0].arb_buff_g[2].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[2].ack_g[l_in]", now.router_id[0].arb_buff_g[2].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[3].req_g[l_in]", now.router_id[0].arb_buff_g[3].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[3].ack_g[l_in]", now.router_id[0].arb_buff_g[3].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[4].req_g[l_in]", now.router_id[0].arb_buff_g[4].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arb_buff_g[4].ack_g[l_in]", now.router_id[0].arb_buff_g[4].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[0].arbitertoken_g[l_in]", now.router_id[0].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].inp_status_g[l_in]", now.router_id[1].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].output_status_g[l_in]", now.router_id[1].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].readbuff_g[l_in]", now.router_id[1].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].writebuff_g[l_in]", now.router_id[1].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[0].req_g[l_in]", now.router_id[1].arb_buff_g[0].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[0].ack_g[l_in]", now.router_id[1].arb_buff_g[0].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[1].req_g[l_in]", now.router_id[1].arb_buff_g[1].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[1].ack_g[l_in]", now.router_id[1].arb_buff_g[1].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[2].req_g[l_in]", now.router_id[1].arb_buff_g[2].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[2].ack_g[l_in]", now.router_id[1].arb_buff_g[2].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[3].req_g[l_in]", now.router_id[1].arb_buff_g[3].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[3].ack_g[l_in]", now.router_id[1].arb_buff_g[3].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[4].req_g[l_in]", now.router_id[1].arb_buff_g[4].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arb_buff_g[4].ack_g[l_in]", now.router_id[1].arb_buff_g[4].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[1].arbitertoken_g[l_in]", now.router_id[1].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].inp_status_g[l_in]", now.router_id[2].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].output_status_g[l_in]", now.router_id[2].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].readbuff_g[l_in]", now.router_id[2].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].writebuff_g[l_in]", now.router_id[2].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[0].req_g[l_in]", now.router_id[2].arb_buff_g[0].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[0].ack_g[l_in]", now.router_id[2].arb_buff_g[0].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[1].req_g[l_in]", now.router_id[2].arb_buff_g[1].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[1].ack_g[l_in]", now.router_id[2].arb_buff_g[1].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[2].req_g[l_in]", now.router_id[2].arb_buff_g[2].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[2].ack_g[l_in]", now.router_id[2].arb_buff_g[2].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[3].req_g[l_in]", now.router_id[2].arb_buff_g[3].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[3].ack_g[l_in]", now.router_id[2].arb_buff_g[3].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[4].req_g[l_in]", now.router_id[2].arb_buff_g[4].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arb_buff_g[4].ack_g[l_in]", now.router_id[2].arb_buff_g[4].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[2].arbitertoken_g[l_in]", now.router_id[2].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].inp_status_g[l_in]", now.router_id[3].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].output_status_g[l_in]", now.router_id[3].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].readbuff_g[l_in]", now.router_id[3].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].writebuff_g[l_in]", now.router_id[3].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[0].req_g[l_in]", now.router_id[3].arb_buff_g[0].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[0].ack_g[l_in]", now.router_id[3].arb_buff_g[0].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[1].req_g[l_in]", now.router_id[3].arb_buff_g[1].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[1].ack_g[l_in]", now.router_id[3].arb_buff_g[1].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[2].req_g[l_in]", now.router_id[3].arb_buff_g[2].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[2].ack_g[l_in]", now.router_id[3].arb_buff_g[2].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[3].req_g[l_in]", now.router_id[3].arb_buff_g[3].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[3].ack_g[l_in]", now.router_id[3].arb_buff_g[3].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[4].req_g[l_in]", now.router_id[3].arb_buff_g[4].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arb_buff_g[4].ack_g[l_in]", now.router_id[3].arb_buff_g[4].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[3].arbitertoken_g[l_in]", now.router_id[3].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].inp_status_g[l_in]", now.router_id[4].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].output_status_g[l_in]", now.router_id[4].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].readbuff_g[l_in]", now.router_id[4].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].writebuff_g[l_in]", now.router_id[4].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[0].req_g[l_in]", now.router_id[4].arb_buff_g[0].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[0].ack_g[l_in]", now.router_id[4].arb_buff_g[0].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[1].req_g[l_in]", now.router_id[4].arb_buff_g[1].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[1].ack_g[l_in]", now.router_id[4].arb_buff_g[1].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[2].req_g[l_in]", now.router_id[4].arb_buff_g[2].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[2].ack_g[l_in]", now.router_id[4].arb_buff_g[2].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[3].req_g[l_in]", now.router_id[4].arb_buff_g[3].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[3].ack_g[l_in]", now.router_id[4].arb_buff_g[3].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[4].req_g[l_in]", now.router_id[4].arb_buff_g[4].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arb_buff_g[4].ack_g[l_in]", now.router_id[4].arb_buff_g[4].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[4].arbitertoken_g[l_in]", now.router_id[4].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].inp_status_g[l_in]", now.router_id[5].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].output_status_g[l_in]", now.router_id[5].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].readbuff_g[l_in]", now.router_id[5].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].writebuff_g[l_in]", now.router_id[5].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[0].req_g[l_in]", now.router_id[5].arb_buff_g[0].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[0].ack_g[l_in]", now.router_id[5].arb_buff_g[0].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[1].req_g[l_in]", now.router_id[5].arb_buff_g[1].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[1].ack_g[l_in]", now.router_id[5].arb_buff_g[1].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[2].req_g[l_in]", now.router_id[5].arb_buff_g[2].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[2].ack_g[l_in]", now.router_id[5].arb_buff_g[2].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[3].req_g[l_in]", now.router_id[5].arb_buff_g[3].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[3].ack_g[l_in]", now.router_id[5].arb_buff_g[3].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[4].req_g[l_in]", now.router_id[5].arb_buff_g[4].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arb_buff_g[4].ack_g[l_in]", now.router_id[5].arb_buff_g[4].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("router_id[5].arbitertoken_g[l_in]", now.router_id[5].arbitertoken_g[l_in]);
		}
	}
		logval("packet_status_g[0].txctr_g", now.packet_status_g[0].txctr_g);
		logval("packet_status_g[0].rcvctr_g", now.packet_status_g[0].rcvctr_g);
		logval("packet_status_g[0].packet_send_g", now.packet_status_g[0].packet_send_g);
		logval("packet_status_g[0].packet_receive_g", now.packet_status_g[0].packet_receive_g);
		logval("packet_status_g[0].start_latencycount_g", now.packet_status_g[0].start_latencycount_g);
		logval("packet_status_g[0].stop_latencycount_g", now.packet_status_g[0].stop_latencycount_g);
		logval("packet_status_g[0].latencycount_g", now.packet_status_g[0].latencycount_g);
		logval("packet_status_g[0].maxlatency_g", now.packet_status_g[0].maxlatency_g);
		logval("packet_status_g[1].txctr_g", now.packet_status_g[1].txctr_g);
		logval("packet_status_g[1].rcvctr_g", now.packet_status_g[1].rcvctr_g);
		logval("packet_status_g[1].packet_send_g", now.packet_status_g[1].packet_send_g);
		logval("packet_status_g[1].packet_receive_g", now.packet_status_g[1].packet_receive_g);
		logval("packet_status_g[1].start_latencycount_g", now.packet_status_g[1].start_latencycount_g);
		logval("packet_status_g[1].stop_latencycount_g", now.packet_status_g[1].stop_latencycount_g);
		logval("packet_status_g[1].latencycount_g", now.packet_status_g[1].latencycount_g);
		logval("packet_status_g[1].maxlatency_g", now.packet_status_g[1].maxlatency_g);
		logval("packet_status_g[2].txctr_g", now.packet_status_g[2].txctr_g);
		logval("packet_status_g[2].rcvctr_g", now.packet_status_g[2].rcvctr_g);
		logval("packet_status_g[2].packet_send_g", now.packet_status_g[2].packet_send_g);
		logval("packet_status_g[2].packet_receive_g", now.packet_status_g[2].packet_receive_g);
		logval("packet_status_g[2].start_latencycount_g", now.packet_status_g[2].start_latencycount_g);
		logval("packet_status_g[2].stop_latencycount_g", now.packet_status_g[2].stop_latencycount_g);
		logval("packet_status_g[2].latencycount_g", now.packet_status_g[2].latencycount_g);
		logval("packet_status_g[2].maxlatency_g", now.packet_status_g[2].maxlatency_g);
		logval("packet_status_g[3].txctr_g", now.packet_status_g[3].txctr_g);
		logval("packet_status_g[3].rcvctr_g", now.packet_status_g[3].rcvctr_g);
		logval("packet_status_g[3].packet_send_g", now.packet_status_g[3].packet_send_g);
		logval("packet_status_g[3].packet_receive_g", now.packet_status_g[3].packet_receive_g);
		logval("packet_status_g[3].start_latencycount_g", now.packet_status_g[3].start_latencycount_g);
		logval("packet_status_g[3].stop_latencycount_g", now.packet_status_g[3].stop_latencycount_g);
		logval("packet_status_g[3].latencycount_g", now.packet_status_g[3].latencycount_g);
		logval("packet_status_g[3].maxlatency_g", now.packet_status_g[3].maxlatency_g);
		logval("packet_status_g[4].txctr_g", now.packet_status_g[4].txctr_g);
		logval("packet_status_g[4].rcvctr_g", now.packet_status_g[4].rcvctr_g);
		logval("packet_status_g[4].packet_send_g", now.packet_status_g[4].packet_send_g);
		logval("packet_status_g[4].packet_receive_g", now.packet_status_g[4].packet_receive_g);
		logval("packet_status_g[4].start_latencycount_g", now.packet_status_g[4].start_latencycount_g);
		logval("packet_status_g[4].stop_latencycount_g", now.packet_status_g[4].stop_latencycount_g);
		logval("packet_status_g[4].latencycount_g", now.packet_status_g[4].latencycount_g);
		logval("packet_status_g[4].maxlatency_g", now.packet_status_g[4].maxlatency_g);
		logval("packet_status_g[5].txctr_g", now.packet_status_g[5].txctr_g);
		logval("packet_status_g[5].rcvctr_g", now.packet_status_g[5].rcvctr_g);
		logval("packet_status_g[5].packet_send_g", now.packet_status_g[5].packet_send_g);
		logval("packet_status_g[5].packet_receive_g", now.packet_status_g[5].packet_receive_g);
		logval("packet_status_g[5].start_latencycount_g", now.packet_status_g[5].start_latencycount_g);
		logval("packet_status_g[5].stop_latencycount_g", now.packet_status_g[5].stop_latencycount_g);
		logval("packet_status_g[5].latencycount_g", now.packet_status_g[5].latencycount_g);
		logval("packet_status_g[5].maxlatency_g", now.packet_status_g[5].maxlatency_g);
		logval("packet_status_g[6].txctr_g", now.packet_status_g[6].txctr_g);
		logval("packet_status_g[6].rcvctr_g", now.packet_status_g[6].rcvctr_g);
		logval("packet_status_g[6].packet_send_g", now.packet_status_g[6].packet_send_g);
		logval("packet_status_g[6].packet_receive_g", now.packet_status_g[6].packet_receive_g);
		logval("packet_status_g[6].start_latencycount_g", now.packet_status_g[6].start_latencycount_g);
		logval("packet_status_g[6].stop_latencycount_g", now.packet_status_g[6].stop_latencycount_g);
		logval("packet_status_g[6].latencycount_g", now.packet_status_g[6].latencycount_g);
		logval("packet_status_g[6].maxlatency_g", now.packet_status_g[6].maxlatency_g);
		logval("packet_status_g[7].txctr_g", now.packet_status_g[7].txctr_g);
		logval("packet_status_g[7].rcvctr_g", now.packet_status_g[7].rcvctr_g);
		logval("packet_status_g[7].packet_send_g", now.packet_status_g[7].packet_send_g);
		logval("packet_status_g[7].packet_receive_g", now.packet_status_g[7].packet_receive_g);
		logval("packet_status_g[7].start_latencycount_g", now.packet_status_g[7].start_latencycount_g);
		logval("packet_status_g[7].stop_latencycount_g", now.packet_status_g[7].stop_latencycount_g);
		logval("packet_status_g[7].latencycount_g", now.packet_status_g[7].latencycount_g);
		logval("packet_status_g[7].maxlatency_g", now.packet_status_g[7].maxlatency_g);
#endif
}
...
{	/* int i; */
	printf("global vars:\n");
		printf("	(struct arb_buff_g)\n");
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.arb_buff_g[ 0 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.arb_buff_g[ 0 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.arb_buff_g[ 1 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.arb_buff_g[ 1 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.arb_buff_g[ 2 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.arb_buff_g[ 2 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.arb_buff_g[ 3 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.arb_buff_g[ 3 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.arb_buff_g[ 4 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.arb_buff_g[ 4 ].ack_g[l_in]);
		}
	}
		printf("	(struct router_id)\n");
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    inp_status_g[%d]:	%d\n", l_in, now.router_id[ 0 ].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    output_status_g[%d]:	%d\n", l_in, now.router_id[ 0 ].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    readbuff_g[%d]:	%d\n", l_in, now.router_id[ 0 ].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    writebuff_g[%d]:	%d\n", l_in, now.router_id[ 0 ].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 0 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 0 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 1 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 1 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 2 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 2 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 3 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 3 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 4 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arb_buff_g[ 4 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	byte   arbitertoken_g[%d]:	%d\n", l_in, now.router_id[ 0 ].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    inp_status_g[%d]:	%d\n", l_in, now.router_id[ 1 ].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    output_status_g[%d]:	%d\n", l_in, now.router_id[ 1 ].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    readbuff_g[%d]:	%d\n", l_in, now.router_id[ 1 ].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    writebuff_g[%d]:	%d\n", l_in, now.router_id[ 1 ].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 0 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 0 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 1 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 1 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 2 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 2 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 3 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 3 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 4 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arb_buff_g[ 4 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	byte   arbitertoken_g[%d]:	%d\n", l_in, now.router_id[ 1 ].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    inp_status_g[%d]:	%d\n", l_in, now.router_id[ 2 ].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    output_status_g[%d]:	%d\n", l_in, now.router_id[ 2 ].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    readbuff_g[%d]:	%d\n", l_in, now.router_id[ 2 ].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    writebuff_g[%d]:	%d\n", l_in, now.router_id[ 2 ].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 0 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 0 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 1 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 1 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 2 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 2 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 3 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 3 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 4 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arb_buff_g[ 4 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	byte   arbitertoken_g[%d]:	%d\n", l_in, now.router_id[ 2 ].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    inp_status_g[%d]:	%d\n", l_in, now.router_id[ 3 ].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    output_status_g[%d]:	%d\n", l_in, now.router_id[ 3 ].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    readbuff_g[%d]:	%d\n", l_in, now.router_id[ 3 ].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    writebuff_g[%d]:	%d\n", l_in, now.router_id[ 3 ].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 0 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 0 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 1 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 1 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 2 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 2 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 3 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 3 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 4 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arb_buff_g[ 4 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	byte   arbitertoken_g[%d]:	%d\n", l_in, now.router_id[ 3 ].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    inp_status_g[%d]:	%d\n", l_in, now.router_id[ 4 ].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    output_status_g[%d]:	%d\n", l_in, now.router_id[ 4 ].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    readbuff_g[%d]:	%d\n", l_in, now.router_id[ 4 ].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    writebuff_g[%d]:	%d\n", l_in, now.router_id[ 4 ].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 0 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 0 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 1 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 1 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 2 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 2 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 3 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 3 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 4 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arb_buff_g[ 4 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	byte   arbitertoken_g[%d]:	%d\n", l_in, now.router_id[ 4 ].arbitertoken_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    inp_status_g[%d]:	%d\n", l_in, now.router_id[ 5 ].inp_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    output_status_g[%d]:	%d\n", l_in, now.router_id[ 5 ].output_status_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    readbuff_g[%d]:	%d\n", l_in, now.router_id[ 5 ].readbuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	int    writebuff_g[%d]:	%d\n", l_in, now.router_id[ 5 ].writebuff_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 0 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 0 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 1 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 1 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 2 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 2 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 3 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 3 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    req_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 4 ].req_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    ack_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arb_buff_g[ 4 ].ack_g[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	byte   arbitertoken_g[%d]:	%d\n", l_in, now.router_id[ 5 ].arbitertoken_g[l_in]);
		}
	}
		printf("	(struct packet_status_g)\n");
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 0 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 0 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 0 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 0 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 0 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 0 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 0 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 0 ].maxlatency_g);
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 1 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 1 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 1 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 1 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 1 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 1 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 1 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 1 ].maxlatency_g);
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 2 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 2 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 2 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 2 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 2 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 2 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 2 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 2 ].maxlatency_g);
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 3 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 3 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 3 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 3 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 3 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 3 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 3 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 3 ].maxlatency_g);
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 4 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 4 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 4 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 4 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 4 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 4 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 4 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 4 ].maxlatency_g);
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 5 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 5 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 5 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 5 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 5 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 5 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 5 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 5 ].maxlatency_g);
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 6 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 6 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 6 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 6 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 6 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 6 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 6 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 6 ].maxlatency_g);
	printf("	int    txctr_g:	%d\n", now.packet_status_g[ 7 ].txctr_g);
	printf("	int    rcvctr_g:	%d\n", now.packet_status_g[ 7 ].rcvctr_g);
	printf("	bit    packet_send_g:	%d\n", now.packet_status_g[ 7 ].packet_send_g);
	printf("	bit    packet_receive_g:	%d\n", now.packet_status_g[ 7 ].packet_receive_g);
	printf("	bit    start_latencycount_g:	%d\n", now.packet_status_g[ 7 ].start_latencycount_g);
	printf("	bit    stop_latencycount_g:	%d\n", now.packet_status_g[ 7 ].stop_latencycount_g);
	printf("	int    latencycount_g:	%d\n", now.packet_status_g[ 7 ].latencycount_g);
	printf("	int    maxlatency_g:	%d\n", now.packet_status_g[ 7 ].maxlatency_g);
	printf("	bit    startproc:	%d\n", now.startproc);
	{	int l_in;
		for (l_in = 0; l_in < 8; l_in++)
		{
			printf("	bit    injectpacket[%d]:	%d\n", l_in, now.injectpacket[l_in]);
		}
	}
	printf("	byte   loop1ctr:	%d\n", now.loop1ctr);
	printf("	byte   loop2ctr:	%d\n", now.loop2ctr);
	printf("	byte   loop3ctr:	%d\n", now.loop3ctr);
	printf("	byte   loop4ctr:	%d\n", now.loop4ctr);
	printf("	byte   loop5ctr:	%d\n", now.loop5ctr);
	printf("	byte   loop6ctr:	%d\n", now.loop6ctr);
	printf("	byte   loop7ctr:	%d\n", now.loop7ctr);
	printf("	byte   testvar:	%d\n", now.testvar);
}
void
...
{	/* int i; */
	...
	case 3:
		...
		break;
	case 2:
		printf("local vars proc %d (startup):\n", pid);
	printf("	byte   portctr:	%d\n", ((P2 *)pptr(pid))->_10_portctr);
	printf("	byte   ctr:	%d\n", ((P2 *)pptr(pid))->_10_ctr);
		break;
	case 1:
		printf("local vars proc %d (controller):\n", pid);
	printf("	int    pactr:	%d\n", ((P1 *)pptr(pid))->_9_pactr);
	printf("	int    lactr:	%d\n", ((P1 *)pptr(pid))->_9_lactr);
	printf("	int    updtpktctr:	%d\n", ((P1 *)pptr(pid))->_9_updtpktctr);
	printf("	int    tctr0:	%d\n", ((P1 *)pptr(pid))->_9_tctr0);
	printf("	int    tctr1:	%d\n", ((P1 *)pptr(pid))->_9_tctr1);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	byte   timerctr[%d]:	%d\n", l_in, ((P1 *)pptr(pid))->_9_timerctr[l_in]);
		}
	}
		break;
	case 0:
		printf("local vars proc %d (router_node):\n", pid);
	printf("	byte   pectr:	%d\n", ((P0 *)pptr(pid))->_8_pectr);
	printf("	int    pactr:	%d\n", ((P0 *)pptr(pid))->_8_pactr);
	printf("	byte   swctr:	%d\n", ((P0 *)pptr(pid))->_8_swctr);
	printf("	byte   arbctr:	%d\n", ((P0 *)pptr(pid))->_8_arbctr);
	printf("	byte   topologyctr:	%d\n", ((P0 *)pptr(pid))->_8_topologyctr);
	printf("	byte   updtctr:	%d\n", ((P0 *)pptr(pid))->_8_updtctr);
	printf("	int    updtpktctr:	%d\n", ((P0 *)pptr(pid))->_8_updtpktctr);
		break;
	}
}
void
